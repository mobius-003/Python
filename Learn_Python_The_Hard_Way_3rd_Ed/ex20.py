...
#call the rewind func to execute - the function will go to the beging of the file
rewind(current_file)

#Prints "Let's print three lines:"
print("Let's print three lines:")

#prints 3 lines (each line is asociaed with every sentance inside the input_file); Prints 1st sentence in the input file - func print_a_line
current_line = 1
print_a_line(current_line, current_file)

#Move to the next line by increming the var 'current_line'; Printing 'print_a_line' func
